...
package com.microsoft.spark.streaming.modules.common


import com.microsoft.azure.powerbi.authentication._
import com.microsoft.azure.powerbi.common._


object PBIAuthentication {

  val powerbiClientId = "client id"
  val powerbiAccountUsername = "user name"
